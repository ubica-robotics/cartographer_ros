...
class Node : public nav2_util::LifecycleNode {
 ...
 private:
  ...
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<::visualization_msgs::msg::MarkerArray>> landmark_poses_list_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<::visualization_msgs::msg::MarkerArray>> constraint_list_publisher_;
